...
// Obtener solo encuestadores de tipo campo (tipo_usu = 4)
$sql_users = "SELECT id_usu, nombre FROM usuarios WHERE tipo_usu = 4 ORDER BY nombre";
$encuestadores = mysqli_query($mysqli, $sql_users);

// Determinar qué opciones mostrar según el tipo de usuario
$mostrar_todos = ($tipo_usu != 4); // Solo mostrar "Todos" si NO es tipo_usu 4
$solo_usuario_actual = ($tipo_usu == 4); // Si es tipo_usu 4, solo mostrar el usuario actual
...
<head>
    ...
    <title>BD SISBEN - Exportar Encuesta Campo</title>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8">
                <h1 class="text-primary fw-bold">
                    <i class="fa-solid fa-address-card me-2"></i> EXPORTAR ENCUESTAS REALIZADAS CAMPO
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="container my-4">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form id="exportForm" action="exportarEncuestador.php" method="get" class="row g-3 align-items-center">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <select name="id_usu" id="encuestador_select" class="form-select">
                            <?php if ($solo_usuario_actual): ?>
                                <!-- Si es tipo_usu 4, solo mostrar el usuario actual -->
                                <option value="<?= $id_usu ?>" selected><?= htmlspecialchars($nombre) ?></option>
                            <?php else: ?>
                                <!-- Para otros tipos de usuario, mostrar todos los encuestadores de campo -->
