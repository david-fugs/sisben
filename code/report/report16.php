<?php
    ...
    header('Content-Disposition: attachment; filename=informe_encuestador_informacion.xls');
    ...
    $query = "SELECT encInfo.id_encInfo,encInfo.fec_rea_encInfo, encInfo.doc_encInfo, encInfo.nom_encInfo, encInfo.tipo_solic_encInfo, encInfo.obs1_encInfo, encInfo.obs2_encInfo, encuestadores.nom_enc   
            ...
            WHERE encInfo.fec_rea_encInfo>='$de' AND encInfo.fec_rea_encInfo<='$hasta' AND usuarios.id_usu='$id_usu' ORDER BY encInfo.fec_rea_encInfo ASC";
    ...
    <table border="1">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td><?php echo utf8_decode($row['nom_encInfo']); ?></td>
                <td style="text-align: center;"><?php echo utf8_decode($row['tipo_solic_encInfo']); ?></td>
                <td><?php echo utf8_decode($row['obs1_encInfo']); ?></td>
                <td><?php echo utf8_decode($row['obs2_encInfo']); ?></td>
