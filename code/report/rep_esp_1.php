...
$query = "
    ...
    FROM 
        encCampo ec
    LEFT JOIN comunas com ON ec.id_com = com.id_com 
    LEFT JOIN barrios bar ON ec.id_bar = bar.id_bar 
    LEFT JOIN corregimientos cor ON ec.id_correg = cor.id_correg 
    LEFT JOIN veredas ver ON ec.id_vere = ver.id_vere 
    LEFT JOIN usuarios usu ON ec.id_usu = usu.id_usu 
    LEFT JOIN encuestadores enc ON usu.id_usu = enc.id_usu 
    LEFT JOIN integCampo ic ON ic.id_encCampo = ec.id_encCampo  
    WHERE 
