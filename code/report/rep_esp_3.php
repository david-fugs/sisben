...
$query = "
    ...
    FROM 
        encMovimientos em
    LEFT JOIN comunas com ON em.id_com = com.id_com 
    LEFT JOIN barrios bar ON em.id_bar = bar.id_bar 
    LEFT JOIN corregimientos cor ON em.id_correg = cor.id_correg 
    LEFT JOIN veredas ver ON em.id_vere = ver.id_vere 
    LEFT JOIN usuarios usu ON em.id_usu = usu.id_usu 
    LEFT JOIN encuestadores enc ON usu.id_usu = enc.id_usu 
    LEFT JOIN integMovimientos im ON im.id_encMovim = em.id_encMovim  
    WHERE 
