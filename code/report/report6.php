<?php
	...
	header('Content-Disposition: attachment; filename=informe_encuestador_campo_familia.xls');
	...
	$query = "SELECT 
            ...
            LEFT JOIN integCampo ON integCampo.id_encCampo=encCampo.id_encCampo  
             WHERE encCampo.fec_rea_encCampo>='$de' AND encCampo.fec_rea_encCampo<='$hasta' AND usuarios.id_usu='$id_usu' GROUP BY encCampo.id_encCampo ORDER BY encCampo.fec_rea_encCampo ASC, encCampo.nom_encCampo ASC";
