        ...
        <form id="form_contacto" action='addsurvey2.php' method="POST" enctype="multipart/form-data">
            ...
            <div class="container pt-2">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label for="otro_bar_ver_encMovim">OTRO BARRIO y/o CORREGIMIENTO:</label>
                            <input type='text' id='otro_bar_ver_encMovim' name='otro_bar_ver_encMovim' class='form-control' />
                        </div>
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type='number' id='integra_encMovim' name='integra_encMovim' class='form-control' value="1" required />
                        </div>
                        <div class="form-group col-md-3">
