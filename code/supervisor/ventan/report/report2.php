<?php
    ...
    header('Content-Disposition: attachment; filename=enc_dig.xls');
    ...
    $query = "SELECT encVentanilla.id_encVenta, encVentanilla.fec_reg_encVenta, encVentanilla.doc_encVenta, encVentanilla.nom_encVenta, encVentanilla.dir_encVenta, encVentanilla.zona_encVenta, comunas.nombre_com, barrios.nombre_bar, corregimientos.nombre_correg, veredas.nombre_vere, encVentanilla.otro_bar_ver_encVenta, encVentanilla.num_ficha_encVenta, encVentanilla.tram_solic_encVenta, encVentanilla.obs_encVenta, encuestadores.nom_enc  
            FROM encVentanilla 
            ...
            WHERE encVentanilla.fec_reg_encVenta>='$de' AND encVentanilla.fec_reg_encVenta<='$hasta' AND usuarios.tipo_usu=3 ORDER BY encVentanilla.fec_reg_encVenta ASC";
    ...
    <table border="1">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td><?php echo $row['nom_encVenta']; ?></td>
                <td><?php echo $row['dir_encVenta']; ?></td>
                <td style="text-align: center;"><?php echo $row['zona_encVenta']; ?></td>
                <td style="text-align: center;"><?php echo $row['nombre_com']; ?></td>
                <td style="text-align: center;"><?php echo $row['nombre_bar']; ?></td>
                <td style="text-align: center;"><?php echo $row['nombre_correg']; ?></td>
                <td style="text-align: center;"><?php echo $row['nombre_vere']; ?></td>
                <td style="text-align: center;"><?php echo $row['otro_bar_ver_encVenta']; ?></td>
                <td style="text-align: center;"><?php echo $row['tram_solic_encVenta']; ?></td>
                <td style="text-align: center;"><?php echo $row['integra_encVenta']; ?></td>
                <td style="text-align: center;"><?php echo $row['num_ficha_encVenta'].' .'; ?></td>
                <td><?php echo $row['nom_enc']; ?></td>
                <td><?php echo $row['obs_encVenta']; ?></td>
            </tr>
            <?php
        }
        ?>
