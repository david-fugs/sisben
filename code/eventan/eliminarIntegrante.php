...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id_integrante'])) {
    ...
    try {
        // Verificar que el integrante existe y obtener información del movimiento        $sql_verificar = "SELECT im.*, m.id_usu as propietario_movimiento 
        ...
        // Marcar como eliminado (cambiar estado a 0)        $sql_eliminar = "UPDATE integmovimientos_independiente 
