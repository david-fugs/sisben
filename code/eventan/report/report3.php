<?php
    ...
    header('Content-Disposition: attachment; filename=informe_movimientos.xls');
    ...
    $query = "SELECT encMovimientos.id_encMovim, encMovimientos.fec_reg_encMovim, encMovimientos.doc_encMovim, encMovimientos.nom_encMovim, encMovimientos.dir_encMovim, encMovimientos.zona_encMovim, comunas.nombre_com, barrios.nombre_bar, corregimientos.nombre_correg, veredas.nombre_vere, encMovimientos.otro_bar_ver_encMovim, encMovimientos.num_ficha_encMovim, encMovimientos.tram_solic_encMovim, encMovimientos.obs_encMovim, encuestadores.nom_enc  
            ...
            WHERE encMovimientos.fec_reg_encMovim>='$de' AND encMovimientos.fec_reg_encMovim<='$hasta' AND encMovimientos.id_usu='$id_usu' ORDER BY encMovimientos.fec_reg_encMovim ASC";
    ...
    <table border="1">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td><?php echo $row['nom_encMovim']; ?></td>
                <td><?php echo $row['dir_encMovim']; ?></td>
                ...
                <td style="text-align: center;"><?php echo $row['otro_bar_ver_encMovim']; ?></td>
                <td style="text-align: center;"><?php echo $row['tram_solic_encMovim']; ?></td>
                <td style="text-align: center;"><?php echo $row['integra_encMovim']; ?></td>
                <td style="text-align: center;"><?php echo $row['num_ficha_encMovim'].' .'; ?></td>
                <td><?php echo $row['obs_encMovim']; ?></td>
            </tr>
            <?php
        }
        ?>
