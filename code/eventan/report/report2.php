<?php
    ...
    header('Content-Disposition: attachment; filename=informe_ventanilla.xls');
    ...
    $query = "SELECT encVentanilla.id_encVenta, encVentanilla.fec_reg_encVenta, encVentanilla.doc_encVenta, encVentanilla.nom_encVenta, encVentanilla.dir_encVenta, encVentanilla.zona_encVenta, comunas.nombre_com, barrios.nombre_bar, corregimientos.nombre_correg, veredas.nombre_vere, encVentanilla.otro_bar_ver_encVenta, encVentanilla.num_ficha_encVenta, encVentanilla.tram_solic_encVenta, encVentanilla.obs_encVenta, encuestadores.nom_enc  
            ...
            WHERE encVentanilla.fec_reg_encVenta>='$de' AND encVentanilla.fec_reg_encVenta<='$hasta' AND encVentanilla.id_usu='$id_usu' ORDER BY encVentanilla.fec_reg_encVenta ASC";
