...
<?php
	...
	$query = "SELECT * FROM `usuarios` INNER JOIN `encCampo` ON usuarios.id_usu=encCampo.id_usu INNER JOIN encuestadores ON usuarios.id_usu=encuestadores.id_usu WHERE (doc_encCampo LIKE '%".$doc_encCampo."%') AND (num_ficha_encCampo LIKE '%".$num_ficha_encCampo."%') ORDER BY encCampo.fec_rea_encCampo ASC, encuestadores.nom_enc ASC";
	...
	$consulta = "SELECT * FROM `usuarios` INNER JOIN `encCampo` ON usuarios.id_usu=encCampo.id_usu INNER JOIN encuestadores ON usuarios.id_usu=encuestadores.id_usu WHERE (doc_encCampo LIKE '%".$doc_encCampo."%') AND (num_ficha_encCampo LIKE '%".$num_ficha_encCampo."%') ORDER BY encCampo.fec_rea_encCampo ASC, encuestadores.nom_enc ASC LIMIT " .(($paginacion->get_page() - 1) * $resul_x_pagina). "," .$resul_x_pagina;
