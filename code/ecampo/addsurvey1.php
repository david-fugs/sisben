    ...
    <script>
        ...
        $(document).ready(function() {
            function actualizarTotal() {
                let total = 0;
                $("input[name='cant_integCampo[]']").each(function() {
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="form-group col-md-4" id="otro_barrio_container" style="display: none;">
                        ...
                        <input type="text" id="otro_bar_ver_encVenta" name="otro_bar_ver_encCampo" class="form-control" placeholder="Ingrese el barrio">
                    </div>
                </div>
            </div>
            <script>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type='number' id='total_integrantes' name='integra_encCampo' class='form-control' value="1" required readonly />
                    </div>
                    <div class="form-group col-md-3">
