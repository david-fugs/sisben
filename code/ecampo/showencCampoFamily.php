            ...
            while($row = mysqli_fetch_array($result))
            {
                echo '
                        <tr>
                            ...
                            <td data-label="EDIT"><a href="showencCampoFamily1.php?id_integCampo='.$row['id_integCampo'].'" ><img src="../../img/editar.png" width=28 height=28></a></td>
                            <td data-label="ELIMINAR"><a href="deleteencCampo.php?id_integCampo='.$row['id_integCampo'].'" ><img src="../../img/eliminar.png" width=28 height=28></a></td>
                        </tr>';
            }
