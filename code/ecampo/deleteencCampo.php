    ...
    <body >
        ...
        ?>
       	...
       	<div class="container">
            ...
            <form action='deleteencCampo1.php' enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='number' name='cant_integCampo' class='form-control'  value='<?php echo $row['cant_integCampo']; ?>' readonly/>
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="gen_integCampo">GENERO</label>
                            <input type='text' name='gen_integCampo' class='form-control'  value='<?php echo $row['gen_integCampo']; ?>' readonly/>
                        </div>
                        <div class="col-12 col-sm-3">
                            <label for="rango_integCampo">EDAD:</label>
                            <select class="form-control" name="rango_integCampo" readonly >
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <label for="estado_integCampo">* CONFIRMAR:</label>
                        <select class="form-control" name="estado_integCampo" required>
                            <option value=""></option>   
